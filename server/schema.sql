...
copy products(id, , body, date_written, answerer_name, answerer_email, reported, helpful) from '/Users/xingvoong/Desktop/hack_reactor/xing-sdc/server/db/answers.csv' with (format csv, delimiter ',', header);
